...
2. 足りない情報を最大5問の質問で引き出す（重複・誘導質問NG）
...
{
  "advice": {
    "refinedOverview": "推奨の伝わる概要原稿",
    "storeBlurb140": "一覧向け140字",
    "headlineIdeas": ["案1", "案2", "案3"],
    "valueBullets": ["便益中心の箇条書き1", "便益中心の箇条書き2", "便益中心の箇条書き3"]
  },
  "questionnaire": [
    {
      "field": "problem|background|scenes|users|differentiation|extensions",
      "question": "質問文",
      "why": "なぜこの質問が必要かの理由（30-80字）"
    }
  ]
}
`.trim();
