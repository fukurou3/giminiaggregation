...
exports.manualTmpCleanup = exports.dailyTmpCleanup = void 0;
 ...
 */
exports.dailyTmpCleanup = functions
    .pubsub
 ...
 */
async function cleanupScheduledFiles(db, bucket) {
    const now = new Date();
 ...
 */
async function cleanupOrphanedTmpFiles(bucket) {
 ...
 */
async function monitorTmpMetrics(bucket, db) {
    try {
        // Count tmp files
 ...
 */
exports.manualTmpCleanup = functions
    .https
